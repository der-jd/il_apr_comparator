...
# Use AWS access key to allow execution of the image in a local environment.
# When the image runs inside the Lambda function, the service execution role is used.
