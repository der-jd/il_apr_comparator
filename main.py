...
if __name__ == "__main__":
    ...
    days_for_il = 30
    currency = "eur"
    current_coin_prices = coin_prices.get_coin_prices(coins, datetime_utc = None, currency = currency)
    datetime_utc = datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(days = days_for_il)
    historical_coin_prices = coin_prices.get_coin_prices(coins, datetime_utc, currency = currency)
